			...
			<div class="row">
				<div class="col-md-12">
					<div class="overview-wrap">
						<h2 class="title-2">Pelatihan Mekaar</h2>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-12">					
					<div class="table-style">
						<table id="datatable" class="table table-bordered table-striped">
							...
							<tbody>
								<?php
								$klasterisasi = array(10,11,12); 
								foreach ($pelatihan_type as $cus){
									if ($this->session->userdata('sess_user_id_user_group')!=4){ //kecuali pic pusat									
										echo '<tr>';
										...
										if (in_array($cus->ID,$klasterisasi)){
											...
											echo '<button type="button" class="btn btn-outline-success col-md-4 add_pelatihan" data-toggle="modal" data-target="#modaladd" data-pelatihantype="'.$cus->ID.'" data-pelatihantitle="'.$cus->TITLE.'"><span class="btn-label"><i class="fas fa-pencil-alt fa-fw"></i></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Add</button></td>'; 											
										echo '</tr>';
										}
										...
										echo '<button type="button" class="btn btn-outline-success col-md-4 add_project_charter" data-toggle="modal" data-target="#modaladdklasterisasi" data-pelatihantype="'.$cus->ID.'" data-pelatihantitle="'.$cus->TITLE.'"><span class="btn-label"><i class="fas fa-pencil-alt fa-fw"></i></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Add Project Charter</button></td>'; 																				
										echo '</tr>';
									}
								}
								?>
