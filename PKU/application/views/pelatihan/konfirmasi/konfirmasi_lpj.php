												...
												echo '<td> 
															<div class="dropdown">
															  ...
															  <div class="dropdown-menu">
																...
																<a class= "dropdown-item pelatihan_approval_lpj" href="#" data-toggle="modal" data-target="#modalapprovallpj" data-pelatihanid="'.$data->ID.'" data-urllampiranlpj="'.$data->URL_LAMPIRAN_LPJ.'" > Verify</a>				
															  </div>
															</div> 
													</td>'; 
                                                echo '</tr>';
