									...
									<table id="datatable_modalview" class="table table-bordered table-striped"> 
										...
										<tbody>
											...
											// foreach ($pelatihan as $data_1){
												...
												// echo '<td>'.$data_1->TITLE.'</td>';
												// echo '<td>'.$data_1->REGIONAL_PNM.'</td>'; 
												// echo '<td>'.$data_1->AREA_PNM.'</td>';
												// echo '<td>'.$data_1->CABANG_PNM.'</td>';
												// echo '<td>'.$data_1->TANGGAL_MULAI.'</br> s/d </br>'.$data_1->TANGGAL_SELESAI.'</td>';
												...
												// {				  
													// echo '<a class="dropdown-item pelatihan_details" href="#" data-toggle="modal" data-target="#modaldetails" 
														...
														// data-pelatihanregion="'.$data_1->REGIONAL_PNM.'"
														// data-pelatihanarea="'.$data_1->AREA_PNM.'"
