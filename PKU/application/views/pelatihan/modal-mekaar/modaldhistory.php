<!-- Modal -->
<div id="modaldhistory" class="modal fade" role="dialog">
	  ...
	  <div class="modal-header">
		...
		<div class="modal-body">
				...
				<div class="form-group row">
					...
					<div class="col-sm-4">
						<select class="form-control" required="" id="cabang_pelatihan_details" name="cabang_pelatihan_details" disabled>
				...
				<div class="form-group row">
					...
					<div class="col-sm-4">
						<input type="text" class="form-control"  required="" id="unit_pelatihan_details" name="unit_pelatihan_details" disabled />
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control"  required="" id="lokasi_pelatihan_details_details" name="lokasi_pelatihan_details" disabled />
					</div>                                
				</div>
						...
						<div class="card-body">
						  <div class="table">                
							<table id="table_rab_details"  class="table">
								  ...
								  <div>
								  <div class="col-md-12">    
									<input type="text" class="form-control money" id="total_cost_rab_akhir_history" name="total_cost_rab_akhir_history" data-a-sign="Rp. " value="" readonly="" required>
								  </div>
...
<script>
	...
	function calculate_grand_total_history(){		
		var total = 0;
		...
		$("#total_cost_rab_akhir_history").val(total);
	}	
</script>