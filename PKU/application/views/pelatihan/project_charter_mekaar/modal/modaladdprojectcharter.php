		...
		<button type="button" class="close" data-dismiss="modal">&times;</button>
			...
			<div class="modal-body">
				...
				<div class="form-group row">
					...
					<div class="col-sm-4">
						<input type="text" class="form-control" id="no_project_charter" name="no_project_charter" readonly />														
					</div>
				</div>				
				...
				<div class="col-sm-12">
					...
					<div class="card-body">
						...
						<table id="table_charter_modaladd"  class="table">
								...
								<tr class="d-none">									
									<td><input type="text" class="form-control" id="judul_pelatihan_charter" maxlength="250" name="judul_pelatihan[]" value=""></td>
									<td>									  
