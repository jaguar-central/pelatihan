		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="form-group row">
					...
					<div class="col-sm-4">
						<input type="text" class="form-control" id="no_project_charter_edit" name="no_project_charter" readonly />														
					</div>
				</div>					
				...
				<div class="form-group row">
					...
					<div class="col-sm-4">
						...
						<label class="custom-file-label" for="customFile_edit">Choose file</label>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="card">
							...
							<div class="card-body">
								<div class="table">
									<table id="table_charter_modaledit" class="table table-responsive">
										...
										<tbody id="tbody_charter_modaledit">
											<tr class="d-none">
												...
												<td><input type="text" class="form-control" id="alamat_pelatihan_edit" maxlength="250" name="alamat_pelatihan[]" value=""></td>
