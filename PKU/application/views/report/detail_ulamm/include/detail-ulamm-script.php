...
<script type="text/javascript">		
	...
	$(document).ready(function() {	
		...
		$("div.tombol").html('<a class="btn btn-success m-2" href="<?php echo base_url('report/download_excel_report_detail_ulamm'); ?>" target="_blank">Download Excel</a>');
	});
